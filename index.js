...
const tadius = new Person('Tadius', 33);
console.log(tadius.toString());
tadius.eat('Burgers', 'cake');
console.log(tadius.stomach);
tadius.poop();
console.log(tadius.stomach); 
/*
  TASK 2
...
const truli = new Lambdasian ('Truli', 34, 'Italy');
console.log(truli.speak()); 
/*
  TASK 4
